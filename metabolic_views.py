...
class GetAvailableModels(APIView):
    ...
    def get(self, request):
        ORGANISMS = {
            "iML1515": "Escherichia Coli MG-1655",
            "iML1515_PKT": "Escherichia Coli PKT",
            "iHN637": "Clostridium Ljungdahlii",
            "RECON1": "Homo Sapiens",
            "iMM904": "Saccharomyces Cerevisiae S288C",
            "iJO1366": "(old) Escherichia Coli MG-1655",
        }
...
class GetAvailableMaps(APIView):
    ...
    def get(self, request):
        ...
        available_maps = [f.split('.')[0] for f in os.listdir(
            maps_path) if f.endswith('.json')]
...
class GetModel(APIView):
    ...
    def get(self, request):
        ...
        model_path = os.path.join(
            STATIC_DIR, 'metabolic', 'models', model_id+'.json')
...
class GetMap(APIView):
    ...
    def get(self, request):
        ...
        map_path = os.path.join(STATIC_DIR, 'metabolic',
                                'maps', map_id+'.json')
